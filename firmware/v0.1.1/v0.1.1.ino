/*
 * ======================================================================================
 * PROJECT IDENTITY: SMART PRESENCE SYSTEM (RFID)
 * ======================================================================================
 ...
 * 
 * HARDWARE MAPPING (ESP32-C3 Super Mini):
 * ---------------------------------------
 ...
 * 
 * FEATURES:
 * - Auto Time Sync (NTP Multi-Server)
 * - Deep Sleep Mode (Auto ON/OFF based on schedule)
 * - HTTPS API Connection with API Key Security
 * - OLED Animation & Signal Strength Indicator
 * ======================================================================================
 */
...
const char WS1[] PROGMEM = "PRESENSI";                                             // SSID Wifi 1
const char WS2[] PROGMEM = "ZEDLABS";                                              // SSID Wifi 2 (Opsional)
const char WP1[] PROGMEM = "PasswordWifi1";                                             // Password Wifi 1
const char WP2[] PROGMEM = "PasswordWifi1";                                             // Password Wifi 2 (Opsional)
const char API[] PROGMEM = "https://contoh.com";              // Sesuaikan dengan APP_URL pada.env
const char KEY[] PROGMEM = "RahasiaAPI";                                 // Sesuaikan dengan API_SECRET pada.env
...
bool kirimPresensi(const char *rfd, char *psn, char *nm, char *sts, char *wkt) {
  ...
  if (!htp.begin(client, url)) {
    strcpy_P(psn, PSTR("GAGAL KONEKSI"));
    return false;
  }
...
void showStartupAnimation() {
  ...
  const char ldg[] PROGMEM = "STARTING v1.2.0";
  const int tln = 7;
