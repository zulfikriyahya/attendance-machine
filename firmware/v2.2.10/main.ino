...
void setup()
{
    ...
    // ----------------------------------------
    // [1] Bangun dari deep sleep: kompensasi lastValidTime dengan durasi sleep
    //     karena millis() reset ke 0 setelah deep sleep
    ...
    // [2] Reset paksa / power putus: RTC RAM hilang, pulihkan dari NVS flash
